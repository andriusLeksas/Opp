...
public class RedPlane implements Plane{
    ...
    public ImageIcon getPlane() {
        ...
        try {
            img = ImageIO.read(this.getClass().getResource("../../res/redPlane.png"));
        } catch (IOException e) {
    ...
    public ImageIcon getPlanePlayer(int id) {
        ...
        if(id == 0){
            try {
                img = ImageIO.read(this.getClass().getResource("../../res/redPlaneWhite.png"));
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
            ...
            try {
                img = ImageIO.read(this.getClass().getResource("../../res/redPlaneBlack.png"));
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
