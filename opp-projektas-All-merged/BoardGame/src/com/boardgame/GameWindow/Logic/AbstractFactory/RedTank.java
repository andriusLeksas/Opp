...
public class RedTank implements Tank {
    ...
    public ImageIcon getTank() {
        ...
        try {
            img = ImageIO.read(this.getClass().getResource("../../res/redTank.png"));
        } catch (IOException e) {
    ...
    @Override
    public ImageIcon getTankPlayer(int id) {
        BufferedImage img = null;
        if(id == 0){
            try {
                img = ImageIO.read(this.getClass().getResource("../../res/redTankWhite.png"));
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
            ...
            try {
                img = ImageIO.read(this.getClass().getResource("../../res/redTankBlack.png"));
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
